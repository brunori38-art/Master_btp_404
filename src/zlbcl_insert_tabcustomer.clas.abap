CLASS zlbcl_insert_tabcustomer DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zlbcl_insert_tabcustomer IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    ...
    data: lt_acc_categ type table of ZLBTAC_CATG_C404,
          lt_catego    type table of ZLBT_CATEGO_C404,
          lt_clientes  type table of ZLBT_CLIENT_C404,
          lt_clnts_lib type table of ZLBT_CLNLIB_C404,
          lt_libros    type table of ZLBT_LIBROS_C404.
...
******** ztacc_catg_c404 ********
    ...
    delete from ZLBTAC_CATG_C404.
    insert ZLBTAC_CATG_C404 from table @lt_acc_categ.
SELECT * FROM ZLBTAC_CATG_C404 INTO TABLE @data(lt).
...
******** ztcatego_c404 ********
    ...
    "Delete possible entries; insert new entries
    delete from ZLBT_CATEGO_C404.
    insert ZLBT_CATEGO_C404 from table @lt_catego.
...
******** ztclientes_c404 ********
    ...
    "Delete possible entries; insert new entries
    delete from ZLBT_CLIENT_C404.
    insert ZLBT_CLIENT_C404 from table @lt_clientes.
...
******** ztclnts_lib_c404
    ...
    "Delete possible entries; insert new entries
    delete from ZLBT_CLNLIB_C404.
    insert ZLBT_CLNLIB_C404 from table @lt_clnts_lib.
...
******** ztlibros_c404 ********
    ...
    "Delete possible entries; insert new entries
    delete from ZLBT_LIBROS_C404.
    insert ZLBT_LIBROS_C404 from table @lt_libros.
